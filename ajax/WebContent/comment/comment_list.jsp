...
<%@ page language="java" contentType="text/xml; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- AJAX_COMMENT 테이블에 저장된 댓글 목록을 검색하여 XML 텍스트 데이타로 응답하는 JSP 문서 --%>    
<%
	List<AjaxCommentDTO> ajaxCommentList=AjaxCommentDAO.getDAO().getAjaxCommentList();
%>
<result>
	<% if(ajaxCommentList.size()!=0) { %>
	<code>success</code>
	<data><![CDATA[
		[
