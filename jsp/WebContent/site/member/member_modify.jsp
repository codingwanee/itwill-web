...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 회원정보를 변경하기 위한 JSP 문서 --%>
<%-- => 입력태그에 변경하고자 회원정보 출력 --%>
<%-- => [회원변경]을 클릭한 경우 회원정보 변경 처리페이지(member_modify_action.jsp) 이동 --%>
...
<form name="modifyForm" id="modify" action="<%=request.getContextPath() %>/site/member/member_modify_action.jsp" method="post">
<fieldset>
...
$("#modify").submit(function() {
	...
	if($("#passwd").val()!="" && $("#passwd").val()!=$("#repasswd").val()) {
