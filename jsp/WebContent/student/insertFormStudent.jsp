...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 학생정보를 입력받기 위한 JSP 문서 --%>
<%-- => [학생추가] 버튼을 누른 경우 학생정보 입력처리페이지(insertStudent.jsp)를 요청하여 입력값 전달 --%>    
...
<%
	...
	//입력값이 저장되어 공유된 DTO 인스턴스를 반환받아 저장
	...
	<table align="center" border="1" cellpadding="1" cellspacing="0" width="300">
		<tr height="40">
			...
			<td width="200" align="center">
				<input type="text" name="no" <% if(student.getNo()!=0) { %> value="<%=student.getNo()%>" <% } %>>
			</td>
		</tr>
		<tr height="40">
