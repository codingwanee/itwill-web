...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- STUDENT 테이블에 저장된 모든 학생정보를 검색하여 응답하는 JSP 문서 --%>
<%-- => [학생추가] 버튼을 누른 경우 학생정보 입력페이지(insertFormStudent.jsp)로 이동 --%>
<%-- => [삭제] 버튼을 누른 경우 학생정보 삭제처리페이지(deleteStudent.jsp)로 이동 --%>
<%-- => [변경] 버튼을 누른 경우 학생정보 변경페이지(updateFormStudent.jsp)로 이동 --%>
<%
	...
	//STUDENT 테이블에 저장된 모든 학생정보를 검색하여 반환하는 메소드 호출
	List<StudentDTO> studentList=StudentDAO.getDAO().getStudentList();
%>
...
<table align="center" border="1" cellspacing="0" cellpadding="1" width="800">
	...
	<tr align="center">
		<td colspan="7">검색된 학생이 한명도 없습니다.</td>
	</tr>	
	<% } else { %>
		...
		<tr align="center">
			...
			<td width="50"><input type="button" value="삭제" onclick="deleteConfirm('<%=student.getNo() %>');"></td>				
